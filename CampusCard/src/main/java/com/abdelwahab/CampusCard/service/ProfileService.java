...
import com.abdelwahab.CampusCard.dto.NationalIdScanResponse;
import com.abdelwahab.CampusCard.dto.ProfilePhotoResponse;
import com.abdelwahab.CampusCard.dto.ProfileResponse;
import com.abdelwahab.CampusCard.dto.UpdateProfileRequest;
...
public class ProfileService {
    ...
    /*
    * get all students approved and public
    */
    ...
    public ProfileResponse getUserProfile(Integer targetUserId, Integer currentUserId, String currentUserRole) {
        ...
        if (!canViewProfile(profile, targetUserId, currentUserId, currentUserRole)) {
            throw new RuntimeException("Access denied: You don't have permission to view this profile");
        }
    ...
    public NationalIdScanResponse uploadNationalIdScan(Integer userId, MultipartFile file) {
        ...
        return com.abdelwahab.CampusCard.dto.NationalIdScanResponse.builder()
                .scanUrl(scanUrl)
